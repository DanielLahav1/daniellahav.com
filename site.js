...
(function () {
  ...
  var REQUEST_ITEMS = {
    ...
    shape: { short: 'Shape-anisotropy preprint', full: 'Preprint: Shape anisotropy in patterned soft ferromagnets is constant only above a crossover field (under review at Communications Physics)' },
    ...
    mad: { short: 'MAD-optimization manuscript', full: 'Manuscript: Multi-Objective Optimization of Magnetic Anomaly Detection with Planar Hall Effect Sensors (submitted to IEEE Sensors Journal)' },
